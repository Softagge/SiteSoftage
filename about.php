                            ...
                            <div class="col-md-6">
                                ...
                                <div class="skill-shortcode">
                                    <div class="skill">
                                        <p>Web Design</p>          
                                        <div class="progress">         
                                            <div class="progress-bar" role="progressbar"  data-percentage="20">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="team-member">
                                    ...
                                    <div class="member-photo">
                                        ...
                                        <div class="member-name">Arthur Guilherme <span>Gerente de Projetos</span></div>
                                    </div>
                                    <!-- Memebr Words -->
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="team-member">
                                    ...
                                    <div class="member-photo">
                                        ...
                                        <div class="member-name">Fábio Aguiar <span>Gerente de Configuração</span></div>
                                    </div>
                                    <!-- Memebr Words -->
                                    <div class="member-info">
                                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat.</p>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="team-member">
                                    ...
                                    <div class="member-photo">
                                        ...
                                        <div class="member-name">Grégory Gomes <span>Gerente de Negócio</span></div>
                                    </div>
                                    <!-- Memebr Words -->
                                    <div class="member-info">
                                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat.</p>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="team-member">
                                    ...
                                    <div class="member-photo">
                                        ...
                                        <div class="member-name">Geandro Nascimento <span>Gerente de Qualidade</span></div>
                                    </div>
                                    <!-- Memebr Words -->
                                    <div class="member-info">
                                        <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore fugiat.</p>
